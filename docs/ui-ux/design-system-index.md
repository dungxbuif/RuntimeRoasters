# Design System Index (Origin Flow V2)

This document maps the **NEW** provided UI designs to their corresponding features and application routes.
...
| `architect_s_canvas` | Base UI Elements | N/A |

## Assets Structure
Each folder contains:
- `code.html`: Tailwind CSS structured HTML.
- `screen.png`: Visual design preview.
