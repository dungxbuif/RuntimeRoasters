...
- public QR trace must show real sold retail cup/order item trace data.
...
2. Client shows QR codes for seeded sold cups/order items.
...
- Public QR trace page opens real sold retail cup/order item trace document.
...
- [ ] Seed data includes at least 2 public traceable sold cups/order items.
