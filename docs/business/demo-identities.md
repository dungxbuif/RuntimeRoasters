...
| Nhóm chức năng | Tên người dùng | Email (Username) | Password mẫu | Role (Mã hệ thống) |
| :--- | :--- | :--- | :--- | :--- |
...
- **JWT Claims**: Role của người dùng được nhúng trực tiếp vào JWT (`role` claim) để các service verify in-memory.
