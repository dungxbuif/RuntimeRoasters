...
## 🛠️ Technical Notes
- Handler không kết nối DB — dữ liệu hardcoded hoàn toàn.
- Đây là ticket cuối cùng của RR-4, đóng vai trò integration test cho toàn bộ infra.
- Sau khi RR-4-5 pass, handler này sẽ được thay thế bởi implementation thực tế ở RR-6.
