...
3.  **Lớp 3: Business Logic (Unit Test)**
    ...
    *   **Quy định Chi tiết:** Agents phải tuân thủ unit-test guardrails trong [VALIDATION.md](./VALIDATION.md).
...
1.  **Cập nhật Tracking:** Điền kết quả vào `docs/work/VALIDATION_MATRIX.md` khi behavior proof thay đổi.
2.  **Chạy Automation:** 
