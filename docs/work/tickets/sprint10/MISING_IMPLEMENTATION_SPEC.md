...
Docs:
- `docs/architecture/ARCHITECTURE.md` describes high-level Farm-to-Cup flow, route simulation concepts, and Kafka/Valkey coordination boundaries.
...
- Script 4: Public QR trace demo using sold cups/items and real trace documents.
...
1. Public Client App page can show QR codes for sold cups/items.
...
Completed planning updates are consolidated in **`docs/requirements/domain/README.md`**.
