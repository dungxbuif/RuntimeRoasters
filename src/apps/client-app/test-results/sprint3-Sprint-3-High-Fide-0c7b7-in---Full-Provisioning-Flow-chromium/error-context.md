...
- Name: sprint3.spec.ts >> Sprint 3: High-Fidelity Flow & Role Constraints >> Persona: System Admin - Full Provisioning Flow
- Location: e2e/sprint3.spec.ts:49:7
...
Locator: locator('[data-e2e="dashboard-header"]')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('[data-e2e="dashboard-header"]')

```

```yaml
- alert: Runtime Roasters
- main
```
