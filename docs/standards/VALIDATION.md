...
1.  **Đọc tệp tin này trước khi viết code:** Agent coi phần Project-Specific Unit Test Rules trong tài liệu này là tiêu chuẩn cao nhất cho chất lượng unit test.
