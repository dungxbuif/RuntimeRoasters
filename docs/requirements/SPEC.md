...
> Current demo truth labels and simulation boundaries live in [Requirements](./REQUIREMENTS.md).
...
3. Client displays a list of QR codes for sold cups/order items.
...
The QR payload should not expose internal primary keys. Use a UI-issued `product_id` as the public QR token; backend persists it on the sold sale item and trace-service exposes the same value as public `trace_code`.
...
| UI-issued cup QR + traceability lookup         | `CQRS Query` endpoint             |
...
| Data Models & Persistence                                                 | `docs/architecture/ERD.md`                       |
| UI/UX Visual Ideas (Visualization Dashboard)                              | `docs/architecture/ui-ux/DESIGN.md`              |
| REST API Specifications                                                   | `docs/architecture/API.md`                       |
| gRPC Contract Definitions                                                 | `docs/architecture/API.md`                       |
| Demo Setup Runbook                                                        | `docs/engineering/SETUP.md`                      |
