...
- Document the chosen fallback in `docs/product/GUIDE.md`.
...
- Update `docs/product/TECH.md` with socket-service, env-owned internal API
  keys, trace-derived topology/history, and OTel correlation design.
- Update `docs/product/SPEC.md` with public/private realtime behavior and
  push/pull demo UX.
- Update `docs/product/GUIDE.md` with local run/debug steps.
